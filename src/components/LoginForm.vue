...
const logInForm = reactive ({
 ...
 const submitButton = () =>{
  ...
  if(logInForm.password === logInForm.confirmPassword && logInForm.password.length === 6 && logInForm.confirmPassword.length === 6){
          ...
          <div class=" w-[400px] h-[500px] top-[10%] z-[999] fixed m-auto bg-white shadow rounded" ref="modal">
            ...
            <div class="absolute w-full block top-12 px-8">
                ...
                <form @submit.prevent="submitButton()" >
                    ...
                    <input v-model="logInForm.confirmPassword" type="text" :class=" logInForm.isPasswordError ? 'border border-red-500' : ''" class="bg-gray-100 w-full focus:outline-none py-0.5 pl-2 text-gray-800 text-base font-normal ">
                    <small v-if="logInForm.isPasswordError" class="text-xs text-red-500 text-center block">password should be same & also be 6 digit </small>
          ...
          <div class=" w-[400px] h-[500px] top-[10%] z-[999] fixed m-auto bg-white shadow rounded" ref="modal">
            ...
            <div class="absolute w-full block top-12 px-8">
                ...
                <form @submit.prevent="submitButton()" >
                    ...
                    <label class=" text-gray-800 text-sm font-medium mt-4 pb-2 block">Password:</label>
                    <input v-model="logInForm.password" type="text" class="bg-gray-100 w-full focus:outline-none py-1 pl-2 text-gray-800 text-base font-normal ">

                    <label class=" text-gray-800 text-sm font-medium mt-4 pb-2 block">Confirm password:</label>
                    <input v-model="logInForm.confirmPassword" type="text" :class=" logInForm.isPasswordError ? 'border border-red-500' : ''" class="bg-gray-100 w-full focus:outline-none py-1 pl-2 text-gray-800 text-base font-normal ">
                    <small v-if="logInForm.isPasswordError" class="text-xs text-red-500 text-center block">password should be same & also be 6 digit </small>
