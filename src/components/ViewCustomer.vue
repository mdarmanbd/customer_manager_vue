...
<template>
    <div class="bg-gray-50 ">
        <div class="md:w-[850px] m-auto pt-5 h-screen">
            ...
            <form v-if="isEditPageShow" @submit.prevent="submitButton()" class="mt-5 px-2 md:px-0">
                <div class="grid md:grid-cols-4">
                    <div class="order-2 md:order-1 md:col-span-3">
                        <div class="flex items-center">
                            ...
                            <input v-model="customer.firstName" type="text" required class="focus:outline focus:outline-gray-400 text-xs md:text-sm font-normal w-full py-1 pl-2 bg-gray-200" placeholder="First name">
                        </div>
                        <div class="flex items-center mt-3">
                            <label class="text-xs md:text-sm text-gray-800 font-medium w-[100px] block ">Last Name: </label>
                            <input v-model="customer.lastName" type="text" class="focus:outline focus:outline-gray-400 text-xs md:text-sm font-normal w-full py-1 pl-2 bg-gray-200" placeholder="Last name">
                        </div>
                        <div class="flex items-center mt-3">
                ...
                <div class="flex items-center mt-3">
                    ...
                    <input v-model="customer.city" type="text" class="focus:outline focus:outline-gray-400 text-xs md:text-sm font-normal w-full py-1 pl-2 bg-gray-200" placeholder="City">
                </div>
                <div class="flex items-center mt-3">
    ...
    <div class="bg-gray-50 ">
        <div class="md:w-[850px] m-auto pt-5 h-screen">
            ...
            <form v-if="isEditPageShow" @submit.prevent="submitButton()" class="mt-5 px-2 md:px-0">
                ...
                <button type="submit" class="mt-3 mb-10 md:mb-5 text-xs md:text-sm bg-cyan-600 block items-center py-1.5 px-3 text-white font-normal rounded cursor-pointer">
                    Submit
                </button>
            </form>
        </div>
